...
Discovery API for the Mentor Hub system — the composite home Card list plus the
standard config, docs, and metrics endpoints. Typed Card lists and Notification
control endpoints land in follow-up tasks.
"""
