...
2. **For each task**, the orchestrator selects an appropriate model. Never use GROK models. Then launch the new agent with:
   - The task file path
...
3. **Completion and documentation**
   ...
   - The sub-agent does not need to commit changes, the orchestration agent will handle that.
